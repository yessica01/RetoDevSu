...
public class ConsumirServicioConsultaUsuarioEnPetstore implements Task {
    private String recurso;

    public ConsumirServicioConsultaUsuarioEnPetstore(String recurso) {
    ...
    public static ConsumirServicioConsultaUsuarioEnPetstore con(String recurso) {
        return Tasks.instrumented(ConsumirServicioConsultaUsuarioEnPetstore.class, recurso);
    }
}